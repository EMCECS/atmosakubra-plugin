 ...
 *       &lt;sequence>
 *         &lt;element name="relationships" type="{http://www.fedora.info/definitions/1/0/types/}RelationshipTuple" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetRelationshipsResponse {
    ...
    public List<RelationshipTuple> getRelationships() {
        if (relationships == null) {
            relationships = new ArrayList<RelationshipTuple>();
        }
