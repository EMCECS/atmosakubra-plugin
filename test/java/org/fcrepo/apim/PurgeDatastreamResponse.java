 ...
 *       &lt;sequence>
 *         &lt;element name="purgedVersionDate" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PurgeDatastreamResponse {
    ...
    protected List<String> purgedVersionDate;
    ...
    public List<String> getPurgedVersionDate() {
        if (purgedVersionDate == null) {
            purgedVersionDate = new ArrayList<String>();
        }
        return this.purgedVersionDate;
    }
